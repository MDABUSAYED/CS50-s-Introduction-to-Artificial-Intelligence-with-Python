...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if father == None and mother == None:
            ...
            parents = {parent:1 - PROBS["mutation"] if parent in two_genes else 0.5 if parent in one_gene else PROBS["mutation"] for parent in parents}

            probability *= parents[father] * parents[mother] if gene == 2 else ((1 - parents[father]) * parents[mother] + parents[father] * (1 - parents[mother])) if gene == 1 else ((1 - parents[father]) * (1 - parents[mother]))
