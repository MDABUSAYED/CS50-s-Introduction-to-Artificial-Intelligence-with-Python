...
class CrosswordCreator():
    ...
    def assignment_complete(self, assignment):
        ...
        """
        #raise NotImplementedError
        return True if len(self.crossword.variables) == len(assignment) else False
    ...
    def select_unassigned_variable(self, assignment):
        ...
        for variable in self.crossword.variables - set(assignment):
            if mrv is None or len(self.domains[variable]) < len(self.domains[mrv]) or len(self.crossword.neighbors(variable)) > len(self.crossword.neighbors(mrv)):
                mrv = variable
        return mrv
